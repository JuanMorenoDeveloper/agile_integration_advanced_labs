...
/**
 * Aggregator implementation which extract the id and salescontact from CorporateAccount and update
 * the Account
 */
public class AccountAggregator implements AggregationStrategy {
  ...
  public Exchange aggregate(Exchange oldExchange, Exchange newExchange) {
    ...
    // System.out.println("Geo is " + account.getCompany().getGeo() + "Client id is " + ca.getId() +
    // ", sales rep is " + ca.getSalesContact());
